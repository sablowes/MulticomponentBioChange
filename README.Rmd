...
01_: scripts to prepare data for analyses. BioTIME data were prepared using code available here: https://github.com/sChange-workshop/BioGeo-BioDiv-Change. Perturbed time series data were compiled and standardised with code written by Alban Sagouis available in subdirecotry temporal_comparison_data_preparation: <https://github.com/sablowes/MulticomponentBioChange/temporal_comparison_data_preparation>
