...
**long_table.csv**: data for *Temporal comparisons: experimental or natural perturbations*. This data was prepared for analysis by Alban Sagouis using code available here: https://github.com/chase-lab/BioTIMEx
