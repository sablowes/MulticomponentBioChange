...
**long_table.csv**: data for *Temporal changes: experimental or natural perturbations*. This data was prepared for analysis by Alban Sagouis using code available in the temporal_change_data_preparation folder.
...
01_: scripts to prepare data for analyses. BioTIME data were prepared using code available here: https://github.com/sChange-workshop/BioGeo-BioDiv-Change. Perturbed time series data were compiled and standardised by Alban Sagouis; code is available in the temporal_change_data_preparation folder.
