...
**long_table.csv**: data for *Temporal comparisons: experimental or natural perturbations*. This data is was prepared for analysis by Alban Sagouis, code available here: https://github.com/chase-lab/BioTIMEx

**PREDICTS_alpha.Rdata**: data for *Spatial comparison: anthropogenic perturbations*

**spatial_natural.Rdata**: data for *Spatial comparison: natural environmental variation* 
