...
load(file = 'temporal_comparison_data_preparation/data/raw data/knops_2018b/ddata')
setDT(ddata)
...
ddata[,
      ':='(   dataset_id = dataset_id,
              ...
              grain_m2 = NA,
              grain_comment = "'4 traps were set in each plot, one per side of the inner 10 x 10 m sampling area.'",
