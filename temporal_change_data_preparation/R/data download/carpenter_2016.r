...
infile1 <- 'temporal_comparison_data_preparation/data/raw data/carpenter_2016/cascade_zooplankton_v0.5_upload.csv'
if(!dir.exists('temporal_comparison_data_preparation/data/raw data/carpenter_2016/') || !file.exists(infile1))   {
   dir.create('temporal_comparison_data_preparation/data/raw data/carpenter_2016/', showWarnings = FALSE)
...
ddata <- dt1
save(ddata, file = 'temporal_comparison_data_preparation/data/raw data/carpenter_2016/ddata')
