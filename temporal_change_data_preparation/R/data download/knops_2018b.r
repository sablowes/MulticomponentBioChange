...
infile1 <- paste0(getwd(),'/data/raw data/knops_2018b/e153_Small mammal abundance.txt')
if(!dir.exists(paste0(getwd(),'/data/raw data/knops_2018b/')) || !file.exists(infile1))   {
   dir.create(paste0(getwd(),'/data/raw data/knops_2018b/'), showWarnings = FALSE)
...
ddata <- dt1
save(ddata, file = paste0(getwd(),'/data/raw data/knops_2018b/ddata'))
