...
infile2 <- 'temporal_change_data_preparation/data/raw data/joern_2020/PBG072.csv'
if(!dir.exists('temporal_change_data_preparation/data/raw data/joern_2020/') || !file.exists(infile2))   {
   dir.create('temporal_change_data_preparation/data/raw data/joern_2020/', showWarnings = FALSE)
...
ddata <- dt2
save(ddata, file = 'temporal_change_data_preparation/data/raw data/joern_2020/ddata')
