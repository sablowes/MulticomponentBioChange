...
infile1 <- 'temporal_change_data_preparation/data/raw data/bateman_2018/641_srbp_birds_7ffe7d716e64a4def128217851d6f2d0.csv'
if(!dir.exists('temporal_change_data_preparation/data/raw data/bateman_2018/') || !file.exists(infile1))   {
   dir.create('temporal_change_data_preparation/data/raw data/bateman_2018/', showWarnings = FALSE)
...
ddata <- dt1
save(ddata, file = 'temporal_change_data_preparation/data/raw data/bateman_2018/ddata')
