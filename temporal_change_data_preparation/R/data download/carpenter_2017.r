...
infile1 <- paste0(getwd(),'/data/raw data/carpenter_2017/cascade_phytoplankton_v0.1.csv_upload.csv')
if(!dir.exists(paste0(getwd(),'/data/raw data/carpenter_2017/')) || !file.exists(infile1))   {
   dir.create(paste0(getwd(),'/data/raw data/carpenter_2017/'), showWarnings = FALSE)
...
ddata <- dt1
save(ddata, file=paste0(getwd(),'/data/raw data/carpenter_2017/ddata'))
