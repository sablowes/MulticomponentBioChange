...
infile18 <- 'temporal_comparison_data_preparation/data/raw data/ellison_2017a/hf113-18-hf-cham-ants.csv'
if(!dir.exists('temporal_comparison_data_preparation/data/raw data/ellison_2017a/') || !file.exists(infile18))   {
   dir.create('temporal_comparison_data_preparation/data/raw data/ellison_2017a/', showWarnings = FALSE)
...
infile21 <- 'temporal_comparison_data_preparation/data/raw data/ellison_2017a/hf113-21-df-cham-ants.csv'
if(!dir.exists('temporal_comparison_data_preparation/data/raw data/ellison_2017a/') || !file.exists(infile21))   {
   dir.create('temporal_comparison_data_preparation/data/raw data/ellison_2017a/', showWarnings = FALSE)
...
save(ddata, file = 'temporal_comparison_data_preparation/data/raw data/ellison_2017a/ddata')
