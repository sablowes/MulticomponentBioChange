...
load(file = 'temporal_comparison_data_preparation/data/raw data/joern_2019/ddata')
setDT(ddata)
...
load('temporal_comparison_data_preparation/data/raw data/joern_2019/ddata_env')
