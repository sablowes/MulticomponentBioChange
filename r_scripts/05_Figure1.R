...
ggplot() +
  ...
  annotate('text', x = 22, y = 3,
           label = 'Delta*PIE', parse = T, size = 2.5) +
  annotate('text', x = 79, y = 26,
           label = 'Delta*S[n]', parse = T, size = 2.5) +
  annotate('text', x = 207, y = 30,
           label = 'Delta*S', parse = T, size = 2.5) +
  annotate('text', x = 135, y = 22,
           label = 'Delta*N', parse = T, size = 2.5) +
...
ggsave(paste0(path2wd, 'Figs/revision/Fig1.pdf'),
       width = 76.2, height = 76.2, units = 'mm')
